...
#section2 {
	background-image:
		url(${pageContext.request.contextPath}/resources/images/bg/bg1.jpg);
	padding: 0 0 6% 0;
	overflow: hidden;
}
</style>
		...
		<div id="fullpage">
			<div class="section aboutUs">
				<div class="sign">
					...
					<img src="<c:out value='${pageContext.request.contextPath}'/>/resources/images/logo/signature.png"
						alt="signature">
				</div>
				<p class="pt36 fadeInDown animated">About Us</p>
				<p class="pt19 fadeInDown animated">&#40;주&#41;나리지식앤컴퍼니는
					&#39;세상의 모든 지식을 말하다&#39;라는 슬로건을 내걸고 지식을 필요로하는 사람과 지식을 가진 사람을 이어주는
					사업으로 출발했습니다. IoT 기반의 어플리케이션과 솔루션 등을 개발하여 IT기업으로 성장한 지금은 Open
					Innovation을 바탕으로 지식-IT 사업을 선도하는 리더로 자리매김하려 합니다.</p>
			...
			<div class="section colfff" id="section2">
				<div class="org_bg" data-ride="animated" data-animation="fadeInLeft"
					data-delay="300">
					<br>
					<p>대표이사</p>
					<p class="pt26">노경환</p>
