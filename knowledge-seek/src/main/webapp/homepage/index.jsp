	...
	<div id="wrap">
		...
		<div id="fullpage">
			<div class="section colfff" id="section0">
				...
				<p class="pt26 shadow fadeInLeft animated">혁신을 바탕으로 지식-IT사업을
					선도하는 리더가 되겠습니다.</p>
				<div class="biz pt20 shadow fadeInUp animated">
					<a href="<c:url value='/homepage/aboutUs.jsp'/>"><span>자세히
							보기</span></a>
				</div>
			</div>
			...
			<div class="section" id="section1">
				<div class="slide" id="slide1">
					...
					<div class="wrap">
						<div class="div3 b1 hover">
							<p class="pt26 shadow colfff">
								솔루션 제작 <br> <span class="pt20 shadow colfff">SI / 웹
									솔루션 / 교육용 소프트웨어</span>
							</p>
						</div>
						<div class="div3 b2 hover">
							<p class="pt26 shadow colfff">
								어플리케이션 제작 <br> <span class="pt20 shadow colfff">IoT
									어플리케이션 / 교육 어플리케이션</span>
							</p>
						</div>
						<div class="div3 b3 hover">
							<p class="pt26 shadow colfff">
								홈페이지 제작 <br> <span class="pt20 shadow colfff">기업
									홈페이지 / 쇼핑몰 구축</span>
							</p>
						</div>
					</div>
				...
				<div class="slide" id="slide2">
					...
					<div class="div2">
						...
						<div class="img2"></div>
						<p class="pt20 col777">
							2015년 중소기업진흥공단 청년창업사관학교 5기 선발 <br>2016년 미래창조과학부 본투글로벌
							스타트업캠퍼스 선발
						</p>
			...
			<div class="section" id="section2">
				...
				<script type="text/javascript">
					var oSeoulCityPoint = new nhn.api.map.LatLng(37.4046237,
							127.1058193); //좌표값 ( 위도, 경도 )
					var defaultLevel = 11;
				...
				<!-- //지도 API -->
				<div class="addr">
					<p class="pt20 shadow colfff">
						<i class="fa fa-phone fa-3x icon-muted"></i><br>070-8624-4536
					</p>
					<p class="pt20 shadow colfff">
						<i class="fa fa-map-marker fa-3x icon-muted"></i><br>경기도 성남시
						분당구 판교로289번길 20<br>3동 310호(삼평동, 스타트업캠퍼스)
					</p>
					<p class="pt20 shadow colfff">
						<i class="fa fa-envelope-o fa-3x icon-muted"></i><br>seek-knowledge@knowledge-seek.com
					</p>
				</div>
