  ...
  <section class="vbox">
    <header class="bg-black dk header navbar navbar-fixed-top-xs">
      <div class="navbar-header aside-md">
        ...
        <a href="${pageContext.request.contextPath}/views/admin/index.jsp" class="navbar-brand" data-toggle="fullscreen"><img src="${pageContext.request.contextPath }/resources/images/logo.png" class="m-r-sm">알랑랑</a>
	                    ...
	                    <tbody><tr>
	                    	...
	                    	<td style="text-align:left">
		                            <div class="radio" style="padding-left:0;">
		                              ...
		                              <label class="radio-custom radio2">
