...
<head>
	...
	<style>
        *{padding:0; margin:0; font-size: 12px; font-family: '맑은 고딕', sans-serif}
        body {background: #61d2d6;}
        ...
        #contents .loginBtn {width:100%; padding: 15px 0; margin-top: 30px; background: #edde45; border:none; border-radius: 3px;}
    </style>
</head>
